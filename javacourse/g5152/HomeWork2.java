 ...
 * {@docRoot}
 * @version 1.52.0.888 v.2
 * @author Kozhushko Sergii sergiikozhushko@gmail.com
 * */
public class HomeWork2 {
    ...
    public static class ConvertFar2Cel {
        ...
        /**Комментарий к методу, метод переводит градусы целсия в шкалу фаренгейта
         * @param celsium Значение градусов Цельсия
         * */
        public static int convertCelsium2Fahrenheit(int celsium) {
            return (int) ((celsium*1.8)+32);
        }
        /** Метод переводит шкалу Фаренгейта в градусы Цельсия*/
